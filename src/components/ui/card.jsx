...
function Card({ className, ...props }) {
  return (
    <div
      className={cn(
        'rounded-2xl border border-outline-variant bg-surface-container-lowest text-card-foreground shadow-[0px_4px_20px_rgba(0,0,0,0.04)] transition-all duration-200',
        className,
      )}
      {...props}
    />
